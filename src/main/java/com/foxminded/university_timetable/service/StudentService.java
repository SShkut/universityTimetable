...
import com.foxminded.university_timetable.exception.GroupSizeExceededException;
...
public class StudentService {
	...
	public void addStudentToGroup(Student student, Group group) {
		...
		if (groupSize < groupMaxSize) {
			...
			throw new GroupSizeExceededException(String.format("Group %s has %d students of %d", 
					group.getName(), groupSize, groupMaxSize));
		}
	}
