...
public class SemesterDao {
	...
	public Semester save(Semester semester) {
		PreparedStatementCreatorFactory factory = new PreparedStatementCreatorFactory(SAVE, Types.INTEGER, Types.VARCHAR);
		factory.setReturnGeneratedKeys(true);
		PreparedStatementCreator psc = factory.newPreparedStatementCreator(Arrays.asList(semester.getYearOfStudy(), semester.getPeriod()));
