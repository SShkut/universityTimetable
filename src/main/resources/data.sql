...
ALTER SEQUENCE semesters_id_seq RESTART WITH 2;
ALTER SEQUENCE groups_id_seq RESTART WITH 3;
ALTER SEQUENCE students_id_seq RESTART WITH 5;
ALTER SEQUENCE teachers_id_seq RESTART WITH 2;
ALTER SEQUENCE rooms_id_seq RESTART WITH 2;
ALTER SEQUENCE timetables_id_seq RESTART WITH 2;
ALTER SEQUENCE daily_timetables_id_seq RESTART WITH 3;
ALTER SEQUENCE time_slots_id_seq RESTART WITH 3;